# `P105303-t` Incrementing digits (version special value)

## Function `increment_digits`

Define function `increment_digits` which returns the string created by incrementing the digits in the original one!
...
More examples can be found [here](./P105303).