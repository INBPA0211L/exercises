# `P105310-t` Decrementing even digits (version special value)

## Function `decrement_even_digits`

Define function `decrement_even_digits` which returns the string created by decrementing the even digits in the original one!
...
More examples can be found [here](./P105310).