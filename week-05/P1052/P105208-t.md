# `P105208-t` Duplicating odd digits (version special value)

## Function `double_odd_digits`

Define function `double_odd_digits` which returns the string created by duplicating the odd digits from the original one!
...
More examples can be found [here](./P105208).