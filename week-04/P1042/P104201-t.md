# `P104201-t` Palindrome array (version special value)

## Function `is_palindrome`

Define function `is_palindrome` which returns whether the elements of the given array is palindrome!
...
More examples can be found [here](./P104201).