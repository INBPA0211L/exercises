# `P104205-t` Strictly monotone decreasing array (version special value)

## Function `is_strictly_monotone_decreasing`

Define function `is_strictly_monotone_decreasing` which returns whether the elements of the given array form a strictly monotone decreasing sequence!
...
More examples can be found [here](./P104205).